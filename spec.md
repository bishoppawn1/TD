...
- Pelagic Atoll is more than 80 percent water, with a central buildable island, two narrow land causeways, six submerged Tidecrawler nests, and two ordinary land gates. Roughly three quarters of each assault approaches through the lagoon as aquatic enemies, so it begins with nine infantry and fourteen structures, including four additional shoreline sentries and two flame turrets covering the northern and southern landings.
...
- Alien portals continuously release ten-hostile swarm packets at short, even intervals instead of single-file trickles or widely separated mass surges. A packet waits until all ten active-enemy slots are available, so the cadence never degrades into partial trickles at the population cap; only the final packet of a wave may contain fewer than ten.
